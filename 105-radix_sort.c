...
/**
 * get_max - Retrieve the maximum value in an array of integers.
...
/**
 * radix_sort - Arrange an array of integers in
 * ascending order using the radix sort algorithm.
 * @array: An array of integers
 * @size: size of the array
 *
 * Description: Implements the Least Significant
 * Digit (LSD) radix sort algorithm.
 */
